...
if __name__ == "__main__":
    ...
    df_result.to_excel("data/test_sets/order-status-check-test-set.xlsx", index=False)
    ...
    df_result.to_excel("data/test_sets/tracking-and-shipping-information-test-set.xlsx", index=False)
    ...
    df_result.to_excel("data/test_sets/return-eligibility-test-set.xlsx", index=False)
    ...
    df_result.to_excel("data/test_sets/order-history-test-set.xlsx", index=False)
    ...
    df_result.to_excel("data/test_sets/shipping-delay-estimate-test-set.xlsx", index=False)
    ...
    df_result.to_excel("data/test_sets/order-assistance-multiple-items-test-set.xlsx", index=False)